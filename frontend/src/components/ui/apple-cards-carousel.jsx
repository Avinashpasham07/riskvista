...
export const Carousel = ({ items, initialScroll = 0 }) => {
    ...
    const handleCardClose = (index) => {
        if (carouselRef.current) {
            const cardWidth = isMobile() ? 230 : 384; // Match card dimensions
                ...
                >
                    ...
                    <div
                        className={cn(
                            ...
                            "max-w-7xl mx-auto" // Adjust for your layout
                        )}
                    >
...
export const Card = ({ card, index, layout = false }) => {
    ...
    return (
        <>
            ...
            >
                <div className="absolute h-full inset-0 bg-gradient-to-b from-black/50 via-transparent to-transparent z-30 pointer-events-none" />
